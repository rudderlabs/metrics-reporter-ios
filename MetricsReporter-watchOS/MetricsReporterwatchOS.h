...
FOUNDATION_EXPORT double MetricsReporterwatchOSVersionNumber;

//! Project version string for MetricsReporter.
FOUNDATION_EXPORT const unsigned char MetricsReporterwatchOSVersionString[];
